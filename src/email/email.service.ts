...
export class EmailService {
  ...
  async sendActivationMail(to: string, activationToken: string): Promise<void> {
    ...
    const backgroundImage = 'https://scontent.xx.fbcdn.net/v/t1.15752-9/363873162_1788779228241965_7958525108006894893_n.png?stp=dst-png_p206x206&_nc_cat=109&ccb=1-7&_nc_sid=aee45a&_nc_ohc=Oatee0_4dEsAX9jCInQ&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdQqjYgO8zYb6qtpK7HBrX3C9pjjsoCc0u0mGrTvsdmp0A&oe=64F97221';
